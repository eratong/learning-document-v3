...
// 去旧版本
// clickAndXuanFu("去旧版本", 50, 450); sleep(baseSleepTime);


// 签到
// clickAndXuanFu("签到", 100, 1800); sleep(baseSleepTime);
// clickAndXuanFu("点击签到领水滴", 800, 900); sleep(baseSleepTime);
// back();

// 浇水
// for (var i = 0; i < 20; i++) {
//     clickAndXuanFu("浇水", 800, 1900 + pageY); sleep(3 * 1000);
// }

// 领水滴
// clickAndXuanFu("领水滴", 250, 1900 + pageY); sleep(baseSleepTime);
...
function guangguang() {
    ...
    for (var i = 0; i < 5; i++) {
        ...
        for (var i = 0; i < 5; i++) {
            ...
            if (currentDongId2 == null || currentDongId2.text() !== "免费水果") {
